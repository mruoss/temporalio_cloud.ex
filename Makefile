...
lib/temporal/%.pb.ex: src/temporalio_cloud_api/temporal/%.proto
	ERL_AFLAGS='-kernel standard_io_encoding latin1' protoc --proto_path=./src/temporalio_cloud_api --proto_path=./src/temporalio_api --proto_path=./src/googleapis --elixir_out=plugins=grpc:./lib $<
